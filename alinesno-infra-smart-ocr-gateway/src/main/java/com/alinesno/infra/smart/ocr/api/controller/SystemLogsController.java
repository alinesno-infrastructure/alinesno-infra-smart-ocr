...
/**
 * 处理与SystemLogsEntity相关的请求的Controller。
 * 继承自BaseController类并实现ISystemLogsService接口。
 *
 * @author LuoXiaoDong
 * @version 1.0.0
 */
...
@RequestMapping("/api/infra/smart/ocr/system_logs")
public class SystemLogsController extends BaseController<SystemLogsEntity, ISystemLogsService> {
    ...
    /**
     * 获取SystemLogsEntity的DataTables数据。
     *
    ...
    @Override
    public ISystemLogsService getFeign() {
        return this.service;
    }
}
